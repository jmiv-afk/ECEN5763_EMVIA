...
#define SKELETAL_TRANSFORM
#define DISPLAY_SKELETAL_TRANSFORM
...
static int              frame_count = 1000000000;
...
#if defined(DISPLAY_SKELETAL_TRANSFORM)
