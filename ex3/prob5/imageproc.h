...
/* @brief Annotates center of mass (COM) with white crosshairs based on thresh
 *
 * @param *fr, a pointer to the pgm to annotate
 * @param thresh, the threshold for COM detection
